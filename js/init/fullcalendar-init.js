...
!function($) {
    ...
    CalendarApp.prototype.onSelect = function (start, end, allDay) {
        var $this = this;
            ...
            form.find(".row")
                .append("<div class='col-md-6'><div class='form-group'><label class='control-label'>Nombre Evento</label><input class='form-control' placeholder='Ingrese un Nombre' type='text' name='title'/></div></div>")
